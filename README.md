...
* HandPrint, SpaCy, and Blender are open, but transcriptions are generated via paid services. Also, accessing the Sketchfab API requires an account.  
### Next Steps
