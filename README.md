# **Longhand** #
Longhand is a python notebook and Blender python script that takes images of handwritten text and returns an immersive visualization. Longhand allows non-technical end users in the humanities to initially engage with a large text corpus during the early stages of research. 
